...
(hablar sobre la factoria de comportamientos y como nos permite crear nuevos comportamientos en hilos independientes para solventar problemas de paralelismo)
...
\begin{itemize}
	\item Personajes: ofrece cuadros de herramientas que permiten incorporar nuevos personajes a la historia (como en la figura \ref{fig:NuevoPersonaje}).
