...
\begin{figure}[h]
	...
	\caption{Flujo de ejecución de un agente y sus comportamientos en JADE. Recuperado de \cite{greenwood}.}
...
En el cuadro de código \ref{mensajeRequest}\footnote{Recuperado de \cite{greenwood}} podemos ver un ejemplo del contenido de un mensaje usando el acto \texttt{Request}:
...
Los cuadros de código \ref{pddlDomain} y \ref{pddlProblema}\footnote{Recuperados de \cite{greenwood}} nos muestran un ejemplo sencillo de cómo se estructura cada fichero y cómo es la sintaxis de PDDL.
