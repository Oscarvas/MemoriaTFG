...
Antes de empezar a considerar lo que cada personaje en específico es capaz de hacer y que función tiene pensada para el desarrollo de la historia, es importante investigar la clase que modela el funcionamiento de los personaje.
...
Gracias a esta clase, todos los agentes que representan personajes comparten ciertos métodos. Estos métodos les permiten realizar tareas comunes a todos ellos, como cargar la información relativa al mundo, localizarse en el mapa o moverse a través de él. También es importante destacar a dos métodos por encima del resto, como son \texttt{planificar} y  \texttt{mandarCrearArchivo} que permite a los distintos personajes planificarse y crear sus archivos \texttt{PDDL}.
...
\subsection{Comportamientos comunes a varios personajes}
...
Estas acciones no están incluidas dentro de la clase \texttt{Personaje}, pero sin embargo es desde esta clase desde donde se invoca su funcionamiento, normalmente a través del método \texttt{planificar}.
...
En resumen, cuando un antagonista guardián se encuentra con un aspirante a héroe, este pedirá ayuda a algún mago disponible y el mago acudirá entablando batalla con el guardián
%-------------------------------------------------------------------
