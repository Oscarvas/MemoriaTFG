...
Aparte los PNJ's registran un comportamiento.
%Se localiza en la loc asignada. Cuando un  personaje consumidor pasa por cierta localizacion se activa. El PNJ crea modificaciones a los atributos aleatorias. A traves de un aleatorio entre 0 y 1, el PNJ sera bueno o malo con ese PJ, dandole los atributos o positivos o negativos.

%explicar aqui el metoco modificar estadisticas
