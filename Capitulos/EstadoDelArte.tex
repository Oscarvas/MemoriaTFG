...
\cite{Wooldridge} Define el concepto de agente de la siguiente manera: \textit{``Un \emph{agente} es un sistema informático que se \emph{encuentra} en un \emph{entorno}, y que es capaz de realizar \emph{acciones autónomas} en este entorno con el fin de cumplir sus objetivos''}.
