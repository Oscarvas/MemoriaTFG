...
%Propongo frase celebre: El trabajo del maestro no consiste tanto en enseñar todo lo aprendible, como en producir en el alumno amor y estima por el conocimiento." (John Locke)
...
Esta tabla y una explicación más detallada de todos los parámetros están disponibles en \cite{aclStructure}. %estan disponibles = son consultables? me parece mas apropiada la segunda
...
\subsection{UNIVERSE} 
Es el primer sistema generador de historias que centra en la narrativa en torno a los personajes. Esta enfocado en la generación de historias como pueden ser las telenovelas o seriales, en donde la historia se centra en las tramas entre  personajes más que en un objetivo final por lo que se generan historias extensas.

\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{Imagenes/UniversePersonaje}
	\caption{Representacion de un personaje en UNIVERSE}
...
\begin{figure}[h]
	...
	\caption{Representacion de una trama en UNIVERSE}
