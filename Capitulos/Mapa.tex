...
Para introducir también la relación entre clases y localizaciones, al archivo XML se le introdujo la relación de tipos, como ya se comento en el capítulo de diseño.
...
\begin{verbatim}
	<region nombre="Isla Egeria">
		<localizacion id="Egeria" tipo="Pueblo" > 
			<conectadoCon>Tesqua Caligo</conectadoCon>
		</localizacion>
	</region>
\end{verbatim}
...
\subsection{La Clase Mapa}

\subsection{La Clase Localización}